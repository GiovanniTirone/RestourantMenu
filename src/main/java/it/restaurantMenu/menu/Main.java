...
import it.restaurantMenu.menu.utilities.MenuFilePDF;
...
public class Main {
    public static void main(String[] args) throws IOException, ClassNotFoundException, FileNotFoundException {
       ...
       Menu menu = new Menu();
        ...
        /*
         - create a MenuFilePDF instance to save menu on file pdf
         - create file pdf for menu, save and write menu on file pdf
         */

        MenuFilePDF menuFilePDF = new MenuFilePDF();
        menuFilePDF.createPDF(menu);
